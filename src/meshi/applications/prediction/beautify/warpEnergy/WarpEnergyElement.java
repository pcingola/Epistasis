...
public class WarpEnergyElement extends EnergyElement {
    ...
    private Atom frozenAtom;
    public WarpEnergyElement(Atom frozenAtom, Atom movingAtom, double weight) {
        distance = null;
        this.movingAtom = movingAtom;
        setAtoms();
        this.weight = weight;
	this.frozenAtom = frozenAtom;
    }

    public void update() {
	if (distance == null) distance = new FreeDistance(movingAtom, frozenAtom);

...
class MinimizeParametersShortLayout implements LayoutManager {
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+248,insets.top+8,72,24);}
        c = parent.getComponent(2);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+56,232,24);}
        c = parent.getComponent(3);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+32,232,24);}
        c = parent.getComponent(4);
        if (c.isVisible()) {c.setBounds(insets.left+248,insets.top+56,72,24);}
        c = parent.getComponent(5);
        if (c.isVisible()) {c.setBounds(insets.left+248,insets.top+32,72,24);}
        c = parent.getComponent(6);
        if (c.isVisible()) {c.setBounds(insets.left+208,insets.top+96,72,24);}
    }
}

...
class HomologyFrame11Layout implements LayoutManager {
    ...
    public void layoutContainer(Container parent) {
        ...
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+120,608,16);}
        c = parent.getComponent(1);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+152,416,24);}
        c = parent.getComponent(2);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+192,416,24);}
        c = parent.getComponent(3);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+312,416,24);}
        c = parent.getComponent(4);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+472,96,32);}
        c = parent.getComponent(5);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+432,96,32);}
        c = parent.getComponent(6);
        if (c.isVisible()) {c.setBounds(insets.left+120,insets.top+472,328,32);}
        c = parent.getComponent(7);
        if (c.isVisible()) {c.setBounds(insets.left+424,insets.top+152,216,24);}
        c = parent.getComponent(8);
        if (c.isVisible()) {c.setBounds(insets.left+424,insets.top+192,216,24);}
        c = parent.getComponent(9);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+232,416,24);}
        c = parent.getComponent(10);
        if (c.isVisible()) {c.setBounds(insets.left+424,insets.top+232,216,24);}
        c = parent.getComponent(11);
        if (c.isVisible()) {c.setBounds(insets.left+424,insets.top+312,216,24);}
        c = parent.getComponent(12);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+272,416,24);}
        c = parent.getComponent(13);
        if (c.isVisible()) {c.setBounds(insets.left+424,insets.top+272,216,24);}
        c = parent.getComponent(14);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+360,144,24);}
        c = parent.getComponent(15);
        if (c.isVisible()) {c.setBounds(insets.left+160,insets.top+360,400,24);}
        c = parent.getComponent(16);
        if (c.isVisible()) {c.setBounds(insets.left+120,insets.top+432,136,32);}
        c = parent.getComponent(17);
        if (c.isVisible()) {c.setBounds(insets.left+544,insets.top+472,96,32);}
        c = parent.getComponent(18);
        if (c.isVisible()) {c.setBounds(insets.left+424,insets.top+48,216,24);}
        c = parent.getComponent(19);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+48,416,24);}
        c = parent.getComponent(20);
        if (c.isVisible()) {c.setBounds(insets.left+8,insets.top+16,616,16);}
    }
}

...
/**
 * IRWLS optimization algorithm (psecifically implemented for Logistic regression)
 * . Originally written for Meshi package.
...
public class Irwls extends Minimizer {
	...
	protected void setParameters(double allowedMaxH // General
		...
		Irwls.maxNumEvaluationsWolfSearch = maxNumEvaluationsWolfSearch;

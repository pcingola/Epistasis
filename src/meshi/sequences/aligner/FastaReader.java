...
public class FastaReader {
	...
	public String getImage() {
		...
		if (tokenizer.hasMoreElements()) img = tokenizer.nextToken(); //gets  first > which after that will be the sequence were looking for
	...
	public String getSource() {
		...
		StringTokenizer tokenizer = new StringTokenizer(str, ">", false);
		if (tokenizer.hasMoreElements()) src = tokenizer.nextToken(); //gets  first > which after that will be the sequence were looking for
		else System.out.println("wrong input1");//TODO change to exceptions

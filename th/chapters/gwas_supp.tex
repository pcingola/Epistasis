...
\fig{gwas_Qhat_vs_PAM1}{gwas_Qhat_vs_PAM1}{14cm}{Comparison (relative ratio) between PAM1 and $\hat{P}(t)$ estimated from $\hat{Q}$
}{Comparison (relative ratio) between PAM1 and $\hat{P}(t)$ estimated from $\hat{Q}$}

...
A co-evolutionary approach for detecting epistatic interactions in genome-wide association studies
...
\substitution{Calculating likelihood of individual and pairs of alignment columns}
...
\fig{gwas_figure_2}{gwasf2}{12cm}{Red & Blue:Histogram of LL(MSA) ``in contact” vs ‘null’ within amino acids within the protein (Pdb). Black: Cummulative probability ratios $R_{MSA} = P[ LL(MSA|M1) > X ] / P[ LL(MSA|M0) > X ]$. Dotted grey: Smoothed $R_{MSA}$}{LL(MSA) in contact vs ‘null’ within protein}
...
\fig{gwas_figure_3}{gwas3a}{12cm}{A) LL(MSA) in contact vs ‘null’ interacting amino acids in co-crystalized proteins (from Pdb), roughly 40\% of interacting records have $LL(MSA) > 1$. B) Log odds ratio of cummulative LL(MSA) probability (interacting / non-interacting)}{LL(MSA) in contact vs ‘null’ interacting amino acids}

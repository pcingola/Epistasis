...
\begin{figure}
    \centering
    \includegraphics[width=14cm]{gwas_epistasis_pipeline.png}
...
\begin{figure}
    \centering
    \includegraphics[width=12cm]{gwas_figure_2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=12cm]{gwas_figure_3A.png}
	\caption{A) LL(MSA) in contact vs ‘null’ interacting amino acids in co-crystalized proteins (from Pdb), roughly 40\% of interacting records have $LL(MSA) > 1$.}
    \label{fig:gwasf3a}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=12cm]{gwas_figure_3B.png}
	\caption{B) Log odds ratio of cummulative LL(MSA) probability (interacting / non-interacting).}
    \label{fig:gwasf3b}
\end{figure}

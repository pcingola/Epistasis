...
Fortunately the number of tests can be reduced significantly. 
...
\fig{gwas_figure_2b_ROC}{gwas_figure_2b_ROC}{12cm}{Classifier's receiver operator curve (ROC).}{Classifier's receiver operator curve (ROC)}
...
Our method attempts to solve three of the main problems common to some of the aforementioned methods: 

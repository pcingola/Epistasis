...
\fig{gwas_figure_3A}{gwas3a}{12cm}{A) LL(MSA) in contact vs ‘null’ interacting amino acids in co-crystalized proteins (from Pdb), roughly 40\% of interacting records have $LL(MSA) > 1$.}{LL(MSA) in contact vs ‘null’ interacting amino acids}
\fig{gwas_figure_3B}{gwas3b}{12cm}{B) Log odds ratio of cummulative LL(MSA) probability (interacting / non-interacting).}{B) Log odds ratio of cummulative LL(MSA) probability (interacting / non-interacting).}

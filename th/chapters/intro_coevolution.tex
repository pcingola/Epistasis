...
A similar approach is based on spin-glass physics uses generalized message-passing techniques to massively parallelize the algorithm implementation \cite{weigt2009identification}.
